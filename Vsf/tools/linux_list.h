...
#else
extern void __list_add(struct list_head *new1,
			      struct list_head *prev,
			      struct list_head *next);
#endif
 ...
 * @new1 : the new element to insert
 *
...
#define list_next_entry2(pos, pos_type, member) \
...
#define list_for_each_entry2(pos, pos_type, head, member)                \
    for (pos = list_first_entry(head, pos_type, member);    \
         &pos->member != (head);                    \
         pos = list_next_entry2(pos, pos_type, member))
